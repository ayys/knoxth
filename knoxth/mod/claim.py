...
class Claim(models.Model):
    ...
    def add_scope(self, context, permissions):
        return self.scopes.get_or_create(context=Context.objects.get_or_create(name=context)[0],
    ...
    def verify(self, permission, context):
        return len([_.permissions & permission for _ in Scope.objects.filter(context__name=context)
